...
<div class="aaa_pts_left_1" onclick="left_open(this,'evaluate')">疾病评估管理</div>
<div class="aaa_pts_left_3" style="display:none;" id="evaluate">
 <ul class="aaa_pts_left_2">
   
   <li>
       <a href="<?php echo U('Evaluate/index');?>" target="iframe">疾病评估管理</a>
   </li>
 </ul>
</div>

<div class="aaa_pts_left_1" onclick="left_open(this,'baike')">医学百科管理</div>
<div class="aaa_pts_left_3" style="display:none;" id="baike">
 <ul class="aaa_pts_left_2">
   
   <li>
       <a href="<?php echo U('Medical/index');?>" target="iframe">医学百科管理</a>
   </li>
   <li>
       <a href="<?php echo U('Medical/add');?>" target="iframe">添加医学百科</a>
   </li>
 </ul>
</div>

<div class="aaa_pts_left_1" onclick="left_open(this,'buliang')">不良事件类型管理</div>
<div class="aaa_pts_left_3" style="display:none;" id="buliang">
 <ul class="aaa_pts_left_2">
   
   <li>
       <a href="<?php echo U('Event/index');?>" target="iframe">类型管理</a>
   </li>
   <li>
       <a href="<?php echo U('Event/add');?>" target="iframe">添加类型</a>
   </li>
 </ul>
</div>

<div class="aaa_pts_left_1" onclick="left_open(this,'tixian')">提现管理</div>
<div class="aaa_pts_left_3" style="display:none;" id="tixian">
 <ul class="aaa_pts_left_2">  
   <li>
       <a href="<?php echo U('Tixian/index');?>" target="iframe">提现管理</a>
   </li>
 </ul>
</div>
