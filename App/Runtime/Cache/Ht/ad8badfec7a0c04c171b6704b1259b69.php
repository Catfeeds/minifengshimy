...
<body>
<div class="aaa_pts_show_1">【 在线诊断管理 】</div>
<div class="aaa_pts_show_2">
    <div>
       <div class="aaa_pts_4"><a href="<?php echo U('index');?>">全部在线诊断</a></div>
    </div>
    <div class="aaa_pts_3">
      <table class="pro_3">
         <tr class="tr_1">
          ...
          <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
            ...
            <td><?php if($vo["state"] == 1): ?>已解决<?php elseif($vo["state"] == 2): ?>已取消<?php else: ?>咨询中<?php endif; ?></td>
            <td>
