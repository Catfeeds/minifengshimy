...
<div class="aaa_pts_show_2">
    ...
    <div class="aaa_pts_3">
      ...
      <ul class="aaa_pts_5">
         ...
         <li>
            ...
            <div>
               <select class="inp_1" id="position" name="position">
                  ...
                  <option value="2" <?php echo $adv_info['position']==2 ? 'selected="selected"' : NULL; ?>>&nbsp;- 首页中部广告</option>
               </select>
            </div>
         </li>
		     <li>
        ...
        <span style="color:red;font-size: 12px;margin-left:1%;">轮播图大小：420*220；中部广告：420*170（前台只显示一张）</span>
         <li data-index="" style="margin-top:10px;">
            ...
            <div>
             <input type="hidden" name="photo" id="photo" value="<?php echo $adv_info['photo']; ?>"/>
              ...
              <img src="/minifengshimy/Data/<?php echo $adv_info['photo']; ?>" width="200" height="100" /><br /><br />
              <?php } ?>
